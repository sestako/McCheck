...
export const AUTH_LOGIN_PATH = process.env.EXPO_PUBLIC_AUTH_LOGIN_PATH ?? '/api/auth/login';
export const AUTH_ME_PATH = process.env.EXPO_PUBLIC_AUTH_ME_PATH ?? '/api/auth/me';
export const AUTH_LOGOUT_PATH = process.env.EXPO_PUBLIC_AUTH_LOGOUT_PATH ?? '/api/auth/logout';
